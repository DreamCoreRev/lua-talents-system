...
fontTalentPointsRemainingText:SetText("|cff00ff96" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
MonkHandlers.ResetAllButtons = function(player)
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentMonkClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentMonkClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
MonkHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cff00ff96" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cff00ff96" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
