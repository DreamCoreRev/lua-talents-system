...
fontTalentPointsRemainingText:SetText("|cFFFF7D0A" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
DruidHandlers.ResetAllButtons = function(player)
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentDruidClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentDruidClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
DruidHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFFF7D0A" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFFF7D0A" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
