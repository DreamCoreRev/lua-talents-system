...
fontTalentPointsRemainingText:SetText("|cFFA330C9" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
DemonhunterHandlers.ResetAllButtons = function(player)
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentDemonhunterClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentDemonhunterClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
DemonhunterHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFA330C9" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFA330C9" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
