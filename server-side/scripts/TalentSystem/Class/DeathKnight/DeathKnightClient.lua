...
fontTalentPointsRemainingText:SetText("|cFFC41F3B" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
DeathknightHandlers.ResetAllButtons = function(player)
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentDeathknightClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentDeathknightClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
DeathknightHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFC41F3B" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFC41F3B" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
