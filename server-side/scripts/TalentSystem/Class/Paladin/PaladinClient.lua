...
fontTalentPointsRemainingText:SetText("|cFFF58CBA" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
PaladinHandlers.ResetAllButtons = function(player)
...

{
    ...
    position = {663, -75},
    handler = "spellspiritualattunement",
    tooltips = {
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentPaladinClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentPaladinClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
PaladinHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFF58CBA" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFF58CBA" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
