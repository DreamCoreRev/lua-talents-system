...
local MAX_TALENTS = 45 -- Définition du nombre maximal de talents que le joueur peut apprendre
...
fontTalentPointsRemainingText:SetText("|cFFDD1133" .. talentPointsRemainingLabel .. " : 0|r")
-------------------------------------------------------------
...
BloodbattlemageHandlers.ResetAllButtons = function(player)
...
saveButton:SetPoint("BOTTOMRIGHT", buttonTalentBloodbattlemageClose, "BOTTOMLEFT", -990, 5) -- Place le bouton Save à gauche du bouton Close
...
buttonReset:SetPoint("BOTTOMRIGHT", buttonTalentBloodbattlemageClose, "BOTTOMLEFT", -880, 5) -- Place le bouton Reset à gauche du bouton Reload
...
BloodbattlemageHandlers.UpdateTalentItemCount = function(player, count)
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFDD1133" .. talentPointsRemainingLabel .. " : " .. count .. "|r")
    end
end
...
local function UpdateTalentCountFromBag()
    ...
    if fontTalentPointsRemainingText then
        fontTalentPointsRemainingText:SetText("|cFFDD1133" .. talentPointsRemainingLabel .. " : " .. (count or 0) .. "|r")
    end
end
