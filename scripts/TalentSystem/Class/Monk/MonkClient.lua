...
CreateSpellButton("buttonSpellFlyingMonk", "Interface/icons/ability_monk_roll", "|cffffffffCoup du moine volant\n|cffffffffTalent |cfff49a01Maître brasseur|r\n|cffffffffRequiert|r |cff00ff96Moine|r\n|cffffd100Effectuez un Coup du moine volant sur une courte distance.|r", "spellflyingmonk", 115, -195)
...
CreateSpellButton("buttonSpellZenPilgrimage", "Interface/icons/spell_monk_zenpilgrimage", "|cffffffffPèlerinage zen\n|cffffffffTalent |cff80fbfcMarche-vent|r\n|cffffffffRequiert|r |cff00ff96Moine|r\n|cffffd100Votre esprit abandonne votre corps et voyage jusqu'au continent de Syphrena.", "spellzenpilgrimage", 805, -465)
