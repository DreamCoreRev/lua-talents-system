...
local NorthrendFlyLevel = 81  -- Which level to learn Cold Weather Flying
...
local function onLogin(event, player)
    player:SendBroadcastMessage("This server is running the |cff4CFF00AutoLearnSkills|r module.")
end
